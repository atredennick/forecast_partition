...
This is referred to as the forecast distribution or the predictive process distribution [@Hobbs2015], which, for one time step ahead of the final observation ($T+1$), is defined as

\begin{equation}
\begin{gathered}
\left[z_{T+1} | y_1,\dots,y_T \right] = \int \dots \int \left[z_{T+1} | z_T,\bm{\uptheta} \right] \\ \left[z_1,\dots,z_T,\bm{\uptheta} | y_1,\dots,y_T \right] d\bm{\uptheta} dz_1 \dots dz_T.
\end{gathered}
\end{equation}
