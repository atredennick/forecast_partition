...
author: "Andrew T. Tredennick$^{1}$^[Corresponding author, Email:atredenn@gmail.com], Mevin B. Hooten$^2$, Peter B. Adler$^1$, and others$^{3}$"
csl: ecology.csl
output:
  pdf_document:
    keep_tex: yes
...
\noindent{}$^3$ Department of somewhere
